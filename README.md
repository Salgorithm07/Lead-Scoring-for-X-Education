...
✅ Objective: The goal was to help X Education, an online learning platform, increase its lead conversion rate from 30% to 80%. I built a logistic regression model that assigns each lead a score from 0 to 100, enabling the sales and marketing teams to prioritize high-potential leads and boost conversion efficiency.

📊 About the Data: The dataset includes lead information from API submissions, landing pages, and organic traffic—covering demographics, behaviour, and source details.
...
Sales Focus: Prioritise leads scoring above 75 for maximum ROI
...
User Engagement: Train chat agents or deploy AI chatbots to enhance real-time conversations
